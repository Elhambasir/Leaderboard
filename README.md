...
**Leaderboard** is an Html,CSS&JavaScript-based project with the implementation of Webpack and gitflow implementation including development server.
...
```sh
  cd my-folder
  https://github.com/Elhambasir/Leaderboard.git
```
...
- [ ] **Dynamic control of adding and deleting scores through inputs **
...
Feel free to check the [issues page](https://github.com/Elhambasir/Leaderboard/issues).
